  ...
  return (
    <div className="self-center mx-auto flex flex-col items-center gap-6 max-w-md sm:max-w-lg md:max-w-3xl lg:max-w-none sm:gap-12 lg:gap-16 py-6 sm:py-8 lg:py-0">
      ...
      <div className="flex flex-col gap-2">
        <div className="pb-1 bg-gradient-to-b from-slate-50 to-slate-400/70 bg-clip-text">
          <h1 className="text-pretty text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-transparent">
